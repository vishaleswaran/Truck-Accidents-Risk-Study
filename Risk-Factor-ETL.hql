--Hive/Impala Table for geolocation tab and load data from Geolocation file
...
--Load the imported file into HIVE by utilizing “LOAD DATA INPATH”
LOAD DATA INPATH '/BigDataHDFS/geolocation.csv' INTO TABLE geolocation_stage;
...
--Load the data from ‘trucks’ input file into the table “trucks”
LOAD DATA INPATH '/BigDataHDFS/trucks.csv' INTO TABLE trucks;
...
LOAD DATA INPATH '/BigDataHDFS/trucks_mg.csv' INTO TABLE trucks;
...
LOAD DATA INPATH '/BigDataHDFS/trucks_mg.csv' INTO TABLE trucks_mg;
